...
$sql="UPDATE `petsitters` SET `sitter_image`='$sitter_image',`sitter_name`='$sitter_name',`sitter_age`='$sitter_age',`sitter_sex`='$sitter_sex',`sitter_phone_1`='$sitter_phone_1',`sitter_phone_2`='$sitter_phone_2',`sitter_phone_3`='$sitter_phone_3',`sitter_adr`='$sitter_adr',`sitter_career_year`='$sitter_career_year',`sitter_career_month`='$sitter_career_month', `sitter_pet`='$sitter_pet',`sitter_price`='$sitter_price',`sitter_word`='$sitter_word' WHERE `user_email`='$user_email'";
